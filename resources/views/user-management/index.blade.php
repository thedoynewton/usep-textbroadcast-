                ...
                <table class="table-auto w-full border dark:border-gray-700">
                    <thead>
                        <tr class="bg-gray-200 dark:bg-gray-700 text-left">
                            ...
                            <th class="px-4 py-2 border dark:border-gray-600 text-gray-800 dark:text-gray-100">Actions
                            </th>
                        </tr>
                    </thead>
                    <tbody>
                                ...
                                <td class="border dark:border-gray-700 px-4 py-2">
                                    <form action="{{ route('user-management.updateRole', $user->id) }}" method="POST"
                                        ...
                                        <select name="role"
                                            ...
                                            <option value="subadmin" {{ $user->role === 'subadmin' ? 'selected' : '' }}>
                                                Sub Admin</option>
                                        </select>
                                        <button type="submit"
                                            class="ml-2 px-4 py-2 bg-blue-500 hover:bg-blue-600 text-black rounded">Update</button>
                                    </form>
                                    <form action="{{ route('user-management.removeRole', $user->id) }}" method="POST"
                                        ...
                                        @method('DELETE')
                                        <button type="submit"
                                            class="px-4 py-2 bg-red-500 hover:bg-red-600 text-black rounded">Remove
                                            Role</button>
                                    </form>
                                </td>
                            </tr>
