    ...
    <table class="min-w-full bg-white border border-black rounded-lg text-center">
        <thead>
            <tr class= "bg-gray-600 text-center">
                <th class="py-2 px-4 border border-black text-xs font-medium text-white tracking-wider">Name
                </th>
                <th class="py-2 px-4 border border-black text-xs font-medium text-white tracking-wider">Email
                </th>
                <th class="py-2 px-4 border border-black text-xs font-medium text-white tracking-wider">
                    Contact Number</th>
                <th class="py-2 px-4 border border-black text-xs font-medium text-white tracking-wider">
                    Campus</th>
                <th class="py-2 px-4 border border-black text-xs font-medium text-white tracking-wider">Type
                </th>
                <th class="py-2 px-4 border border-black text-xs font-medium text-white tracking-wider">
                    Actions</th>
            </tr>
        ...
        <tbody>
            @foreach ($contacts as $contact)
                <tr class="hover:bg-red-100 transition duration-150 ease-in-out">
                    ...
                    <td class="border dark:border-gray-700 px-2 py-1 text-xs">{{ $contact->stud_email ?? $contact->emp_email }}
                    </td>
                    <td class="border dark:border-gray-700 px-2 py-1 text-xs">
                        {{ $contact->stud_contact ?? $contact->emp_contact }}</td>
                    <td class="border dark:border-gray-700 px-2 py-1 text-xs">{{ $contact->campus->campus_name ?? 'N/A' }}</td>
                    <td class="border dark:border-gray-700 px-2 py-1 text-xs">
