    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-xl sm:rounded-lg p-6">
                ...
                <!-- Students Section -->
                <h3 class="text-lg font-semibold mb-4 text-gray-800 dark:text-gray-100">Students (Total:
                    {{ $totalStudents }})</h3>
                    ...
                    <tbody>
                        @foreach ($students as $student)
                            <tr class="bg-white dark:bg-gray-900">
                                <td class="border dark:border-gray-700 px-4 py-2">{{ $student->stud_fname }}
                                    {{ $student->stud_lname }}</td>
                                ...
                                <td class="border dark:border-gray-700 px-4 py-2">
                                    {{ $student->campus->campus_name ?? 'N/A' }}</td>
                            </tr>
                        @endforeach
                    </tbody>
                </table>
                ...
                <!-- Employees Section -->
                <h3 class="text-lg font-semibold mt-8 mb-4 text-gray-800 dark:text-gray-100">Employees (Total:
                    {{ $totalEmployees }})</h3>
                <table class="table-auto w-full border dark:border-gray-700">
                    <thead>
                        <tr class="bg-gray-200 dark:bg-gray-700 text-left">
                    ...
                    <tbody>
                        @foreach ($employees as $employee)
                            <tr class="bg-white dark:bg-gray-900">
                                <td class="border dark:border-gray-700 px-4 py-2">{{ $employee->emp_fname }}
                                    {{ $employee->emp_lname }}</td>
                                ...
                                <td class="border dark:border-gray-700 px-4 py-2">
                                    {{ $employee->campus->campus_name ?? 'N/A' }}</td>
                            </tr>
                        @endforeach
                    </tbody>
                </table>
